...
const TABLE_CONFIGS: Record<TableName, TableConfig> = {
    ...
    tasks: {
        mapper: (t: any) => ({ id: t.id, projectId: t.project_id, milestoneId: t.milestone_id, engineerId: t.engineer_id, title: t.title, description: t.description, status: t.status, createdAt: t.created_at, startDate: t.start_date, dueDate: t.due_date, priority: t.priority || 'medium', isAutoGenerated: t.is_auto_generated }),
        orderBy: 'created_at', ascending: false,
    },
    leave_requests: {
